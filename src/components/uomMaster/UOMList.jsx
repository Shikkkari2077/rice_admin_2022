...
import { fetchUOMList } from "../../store/index";
...
openModel = () => {
  ...
  selctSingle = (e, id) => {
    ...
    // this.props.uom_list.data.forEach(d => {
    //   this.setState({
    ...
    let newArray = this.props.uom_list.data.filter((d) => {
      // console.log(d)
                ...
                <div className="col-lg-4">
                  <div className="page-header-breadcrumb">
                    <ul className="breadcrumb-title">
                      ...
                      <li className="breadcrumb-item active">UOM List</li>
                    </ul>
                  </div>
                </div>
              </div>
...
export default connect(mapStateToProps, { fetchUOMList})(uomMaster);