...
import { fetchProductDepartmentList } from "../../store/index";
...
class ProductDepartment extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      hideOld: false,
...
openModel = () => {
  ...
  selctSingle = (e, id) => {
    ...
    // this.props.product_department.data.forEach(d => {
    //   this.setState({
    ...
    let newArray = this.props.product_department.data.filter((d) => {
      // console.log(d)
  ...
  render() {
    ...
    const options = {
      ...
      textLabels: {
        body: {
          noMatch: !this.props.product_department
                ...
                <div className="col-lg-8">
                  <div className="page-header-title">
                    <div className="d-inline">
                      <h4>Product Department List</h4>
                    </div>
                  </div>
                  {/* <CSVLink
                    data={this.props.product_department}
                ...
                <div className="col-lg-4">
                  <div className="page-header-breadcrumb">
                    <ul className="breadcrumb-title">
                      ...
                      <li className="breadcrumb-item active">Product Department List</li>
                    </ul>
                  </div>
                </div>
              </div>
...
{/* 
                      ...
                      <div className="dt-responsive table-responsive">
                        ...
                        >
                         ...
                         {this.props.product_department.length < 49 ? 
                             <li class="page-item btn btn-disabled">
...
export default connect(mapStateToProps, { fetchProductDepartmentList})(ProductDepartment);