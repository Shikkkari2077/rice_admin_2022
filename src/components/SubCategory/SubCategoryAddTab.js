...
class SubCategoryAddTab extends React.Component {
  state = {};
  componentDidMount() {
    if (
      this.props.match.params.subcategory_id !== undefined &&
      this.props.match.params.subcategory_id !== null &&
      this.props.match.params.subcategory_id !== 0 &&
      this.props.match.params.subcategory_id !== ""
    ) {
      this.setState({ subcategory_id: this.props.match.params.subcategory_id });
    }
              ...
              <div className="col-lg-8">
                <div className="page-header-title">
                  <div className="d-inline">
                    <h4>
                      {this.props.match.params.subcategory_id ? "Edit" : "Add"}{" "}
                      SubCategory
                    </h4>
                  </div>
                </div>
...
SubCategoryAddTab.propTypes = {
  getUsers: PropTypes.func.isRequired,
  login: PropTypes.object.isRequired,
  error: PropTypes.object.isRequired,
};
export default connect(mapStateToProps, {})(SubCategoryAddTab);
