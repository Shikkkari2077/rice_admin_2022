    ...
    brand_data_list: [
      {
        id: "1",
        user:"John doe",
        name_en: "Lorem ipsum akhhe alheig lahlaig hauehgj safekheo",
      },
    ],
  };
                ...
                <div className="col-lg-4">
                  <div className="page-header-breadcrumb">
                    <ul className="breadcrumb-title">
                      ...
                      <li className="breadcrumb-item active">Article Comments List</li>
                    </ul>
                  </div>
                </div>
              </div>
