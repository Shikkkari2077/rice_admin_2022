...
class GalleryPopUp extends Component {
	...
	this.props.getGallery(this.props.media_type,this.state.datarange,this.state.dataLength)
		
	}
	componentWillReceiveProps(nextProps,prev) {
		
        console.log(nextProps)
	// 	if(this.state.type !== nextProps.props.media_type)
	// 	{
    ...
    selected=(e)=>{
      ...
      this.props.imagedata(e.target.src,e.target.id)
      this.props.close()
    }
	render() {
		return (
							...
							<div className="row align-items-end">
								...
								{/* <div className="col-lg-8">
									<div className="page-header-title">
										<div className="d-inline d-flex ">
												...
												<h4> {this.state.type !== undefined?this.state.type.toUpperCase():null} MEDIA </h4>{' '}
                                ...
                                <div className="card col-12 ">
                                    ...
                                    <div className="float-right">
                                            <i class="icofont icofont-close-squared"
                                               style={{ zoom: "1.8", padding: "2px", cursor: "pointer" }}
                                          ...
                                          {  
                                             ...
                                             this.props.banner_gallery.map(image=>{
                                                ...
                                                <div className="col-2 text-center">
                                                 <img id={image.id} src={image.url} style={{height:"100px",width:"100px"}}
...
export default connect(mapStateToProps, { getGallery })(GalleryPopUp);
