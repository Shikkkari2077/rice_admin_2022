...
import { getBannerMediaList } from '../../store/index';
...
class Banner extends React.Component {
	...
	// };
	componentWillMount() {
		this.props.getBannerMediaList();
	}
	componentWillReceiveProps(nextProps) {
		if (nextProps.bannerMedia.bannerMediaList) {
         const bannerMediaList = nextProps.bannerMedia.bannerMediaList
			this.setState({ bannerMediaList });
		}
	}
	imgLoadError = (event) => {
								...
								<div className="col-lg-4">
									<div className="page-header-breadcrumb">
										<ul className="breadcrumb-title">
											...
											<li className="breadcrumb-item active">Banner Media List</li>
										</ul>
									</div>
								</div>
							</div>
										...
										<div className="card-block">
											<div className="col">
												{localStorage.getItem('role') === 'admin' ? (
													...
													>
														{' '}
														<i className="icofont icofont-plus m-r-5"></i> Add Banner Media{' '}
													</Link>
												) : null}
											</div>
											<div className="dt-responsive table-responsive">
												<MuiThemeProvider theme={this.getMuiTheme()}>
													<MUIDataTable
														...
														data={this.state.bannerMediaList}
														columns={columns}
														options={options}
													/>
												</MuiThemeProvider>
...
Banner.propTypes = {};
export default connect(mapStateToProps, { getBannerMediaList })(Banner);
