...
class RoleCreationAdd extends React.Component {
  state = {
    status: "Active",
    description: "",
    MediaId: "",
    policy: [
      { id: "1", name: "can see dashboard " },
      { id: "2", name: "can upload product master" },
      { id: "3", name: "can upload seller list" },
    ],
  };
...
RoleCreationAdd.propTypes = {
  getUsers: PropTypes.func.isRequired,
  login: PropTypes.object.isRequired,
  error: PropTypes.object.isRequired,
};
export default connect(mapStateToProps, {})(RoleCreationAdd);
