...
class KYCListApproved extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
     popupimage:'',
  ...
  { 
   Swal.fire({
    ...
    this.props.updateKycStatus(user.id,statusKyc)
     }})
   }
  ...
  this.props.updateKycStatusfinal(user.id,false,'pending') 

  this.props.updateKycStatus(user.id,event.target.value)
  }

  
  }
  componentWillMount() {
    this.props.fetchCustomerKyc("KYC approved",this.state.datarange,this.state.dataLength)
...
openModel = () => {
  ...
  handlePageChange(pageNumber) {
    ...
    // this.state.kycStatusfilter !== "KYC approved"  ? this.state.kycStatusfilter : "KYC approved";
    this.props.fetchCustomerKyc("KYC approved",range,dataLength," ",this.state.searchNumber )
   ...
   onsearchButton=()=>{
    ...
    this.setState({
     ...
     this.props.fetchCustomerKyc("KYC approved",this.state.datarange,this.state.dataLength,"",this.state.searchNumber)
   }
   oncancelButton=()=>{
    this.setState({
      searchNumber:"",
  ...
  // onGo = () => {
    ...
    // var status = this.state.kycStatusfilter !== "all" && 
    //               this.state.kycStatusfilter !== "" ? this.state.kycStatusfilter : "";
   // console.log(status)
  //  this.props.fetchCustomerKyc("KYC approved",this.state.datarange,this.state.dataLength)
...
export default connect(mapStateToProps, { 
  ...
  updateKycStatus,
  updateKycStatusfinal,
	fetchPincodeList,})(KYCListApproved);