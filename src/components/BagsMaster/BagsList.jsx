...
import { fetchBagList } from "../../store/index";
...
openModel = () => {
  ...
  selctSingle = (e, id) => {
    ...
    // this.props.bags_list.data.forEach(d => {
    //   this.setState({
    ...
    let newArray = this.props.bags_list.data.filter((d) => {
      // console.log(d)
                ...
                <div className="col-lg-4">
                  <div className="page-header-breadcrumb">
                    <ul className="breadcrumb-title">
                      ...
                      <li className="breadcrumb-item active">Bags List</li>
                    </ul>
                  </div>
                </div>
              </div>
...
{/* 
                      ...
                      <div className="dt-responsive table-responsive">
                        ...
                        >
                         ...
                         {this.props.bags_list.length < 49 ? 
                             <li class="page-item btn btn-disabled">
...
const mapStateToProps = (state) => {
  return {
    ...
    isLoading:state.Bags.isLoading
  };
};
BagsList.propTypes = {
    fetchBagList: PropTypes.func.isRequired,
};
export default connect(mapStateToProps, { fetchBagList})(BagsList);