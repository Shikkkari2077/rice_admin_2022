...
import {fetchAssignedAdminPolicies,updateAssignedAdminpolicy} from "../../../store/index";
...
import Swal from "sweetalert2";
class UserPolicyAssignedList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      enable: false,
  ...
  componentDidMount(){
    this.props.fetchAssignedAdminPolicies(this.props.match.params.group_id)
  }
  ...
  onSaveData(){
    ...
    Swal.fire({
        ...
        confirmButtonText:' Yes',
          ...
          { 
            this.props.updateAssignedAdminpolicy(this.props.match.params.group_id,this.state.finalsubmitarray)
          }
      ...
      <div>
          ...
          <div className="card text-center" style={{height:"100%"}} >
              ...
              <div style={{paddingTop:"15px",alignContent:"right"}}>
                  ...
                  <button
                    onClick={ ()=>(window.location.href="#/user/assign/list") }
                    className="btn btn-grd-disabled mr-2"
                  >
                  ...
                  <Link
                  to={"/user_policy/assign/" + this.props.match.params.group_id}
...
UserPolicyAssignedList.propTypes = {
    fetchAssignedAdminPolicies:PropTypes.func.isRequired,
    updateAssignedAdminpolicy:PropTypes.func.isRequired,
 
  error: PropTypes.object.isRequired,
};
export default connect(mapStateToProps, {
    fetchAssignedAdminPolicies,updateAssignedAdminpolicy

})(UserPolicyAssignedList);
