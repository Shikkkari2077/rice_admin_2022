        ...
        {this.state.isLoading ? (
          ...
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="form-group row">
                  <label className="col-sm-3 col-form-label">Seller category</label>
                  <div className="col-sm-9">
                    <select
                      name="sellerCat"
                      className="form-control"
                      value={this.state.sellerCat}
                      onChange={this.handleChange}
                    >
              ...
              <div className="col-md-6">
                <div className="form-group row">
                  <label className="col-sm-3 col-form-label">Order Code</label>
                  <div className="col-sm-9">
                    <input
                      type="text"
                      className="form-control"
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-9">
                    <select
                      ...
                      onChange={this.handleChange}
                    >
                      <option value={true}>--Select Pincode--</option>
                      <option value={true}>221005</option>
                      <option value={false}>221006</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6">
                <div className="form-group row">
                  <label className="col-sm-3 col-form-label">FSSAI</label>
                  <div className="col-sm-9">
                    <input
                      type="text"
                      className="form-control"
              ...
              <div className="col-md-6">
                <div className="form-group row">
                  <label className="col-sm-3 col-form-label">Ratings</label>
                  <div className="col-sm-9">
                    <input
                      type="text"
                      className="form-control"
