...
import { fetchDeliveryTypeList } from "../../store/index";
...
openModel = () => {
  ...
  selctSingle = (e, id) => {
    ...
    // this.props.DeliveryTypesList.data.forEach(d => {
    //   this.setState({
    ...
    let newArray = this.props.DeliveryTypesList.data.filter((d) => {
      // console.log(d)
  ...
  render() {
    ...
    const options = {
      ...
      textLabels: {
        body: {
          noMatch: !this.props.DeliveryTypesList
                ...
                <div className="col-lg-8">
                  <div className="page-header-title">
                    <div className="d-inline">
                      <h4>Delivery Types List</h4>
                    </div>
                  </div>
                  {/* <CSVLink
                    data={this.props.DeliveryTypesList}
                ...
                <div className="col-lg-4">
                  <div className="page-header-breadcrumb">
                    <ul className="breadcrumb-title">
                      ...
                      <li className="breadcrumb-item active">Delivery Types List</li>
                    </ul>
                  </div>
                </div>
              </div>
...
{/* 
                      ...
                      <div className="dt-responsive table-responsive">
                        ...
                        >
                         ...
                         {this.props.DeliveryTypesList.length < 49 ? 
                             <li class="page-item btn btn-disabled">
...
export default connect(mapStateToProps, { fetchDeliveryTypeList})(BrandList);