...
import { fetchPortList, fetchcityList } from "../../store/index";
...
class PortsList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      hideOld: false,
...
openModel = () => {
  ...
  selctSingle = (e, id) => {
    ...
    // this.props.port_list.data.forEach(d => {
    //   this.setState({
    ...
    let newArray = this.props.port_list.data.filter((d) => {
      // console.log(d)
      ...
      },
      {
        ...
        options: {
          ...
          customBodyRender: (cityId, tableMeta) => {
            var CityList = this.state.city_list
            // console.log('CityList',CityList);
            var City = CityList.length>0? CityList.filter(data=>data.id === cityId)[0].name:[]
                ...
                <div className="col-lg-4">
                  <div className="page-header-breadcrumb">
                    <ul className="breadcrumb-title">
                      ...
                      <li className="breadcrumb-item active">Ports List</li>
                    </ul>
                  </div>
                </div>
              </div>
...
{/* 
                      ...
                      <div className="dt-responsive table-responsive">
                        ...
                        >
                         ...
                         {this.props.port_list.length < 49 ? 
                             <li class="page-item btn btn-disabled">
...
export default connect(mapStateToProps, { fetchPortList,fetchcityList})(PortsList);