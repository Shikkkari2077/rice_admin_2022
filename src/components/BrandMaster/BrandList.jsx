...
import { fetchBrandList } from "../../store/index";
...
openModel = () => {
  ...
  selctSingle = (e, id) => {
    ...
    // this.props.brand_list.data.forEach(d => {
    //   this.setState({
    ...
    let newArray = this.props.brand_list.data.filter((d) => {
      // console.log(d)
...
{/* 
                      ...
                      <div className="dt-responsive table-responsive">
                        ...
                        >
                         ...
                         {this.props.brand_list.length < 49 ? 
                             <li class="page-item btn btn-disabled">
...
export default connect(mapStateToProps, { fetchBrandList})(BrandList);