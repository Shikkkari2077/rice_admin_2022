            ...
            <ul className="nav-right">
              {/* {
                localStorage.getItem('superadmin_role') === "shop"
                  ...
                  : */}
              <li className="user-profile header-notification">
                <img src={img} className="img-radius" alt="img" />
                <span>{localStorage.getItem("sellerName")?localStorage.getItem("sellerName"): localStorage.getItem('role')==="admin"?"Admin":localStorage.getItem("superadmin_name")  }</span>
              </li>
